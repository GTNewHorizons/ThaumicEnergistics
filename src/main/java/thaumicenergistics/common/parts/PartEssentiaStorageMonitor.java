...
public class PartEssentiaStorageMonitor extends ThEPartBase
    ...
    protected class TrackingInformation {
        ...
        public Boolean setTracked(final IAspectStack as) {
            ...
            if (!(trackedNull || asNull)) {
                ...
                didChange = ((this.asAspectStack.getStackSize() != as.getStackSize())
                        || (this.asAspectStack.getAspect() != as.getAspect()));
                if (didChange) {
                    // Update
    ...
    public void writeToNBT(final NBTTagCompound data, final PartItemStack saveType) {
        ...
        if (this.trackedEssentia.isValid()) {
            // Write the aspect
            data.setString(
                    PartEssentiaStorageMonitor.NBT_KEY_TRACKED_ASPECT,
                    this.trackedEssentia.getAspectStack().getAspectTag());
        }
    }
