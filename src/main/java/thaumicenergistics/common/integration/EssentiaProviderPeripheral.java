...
public class EssentiaProviderPeripheral implements IPeripheral, IEssentiaProviderWatcher {
    ...
    private static class CCHelpObject implements ILuaObject {
        ...
        @Override
        public Object[] callMethod(final ILuaContext context, final int method, final Object[] arguments)
    ...
    private static enum CCMethods {
         ...
         * List of methods.
         */
        public static final EssentiaProviderPeripheral.CCMethods[] VALUES;
    ...
    private class EssentiaWatcher implements IMEMonitorHandlerReceiver<AEEssentiaStack> {
         ...
         */
        public void addComputerWatch(final IComputerAccess computer, final Set<Aspect> aspectsOfInterest)
                throws LuaException, InterruptedException {
     ...
     */
    private static final Hashtable<String, Aspect> aspectNameReverseMap = new Hashtable<String, Aspect>();
     ...
     * @throws InterruptedException
     */
    private boolean ccRegisterAsWatcher(final IComputerAccess computer, final Object[] args)
            throws LuaException, InterruptedException {
        // No provider
