...
public enum ThEStrings {
    ...
    Item_EssentiaCell_256k("item.essentia.cell.256k", true),
    Item_EssentiaCell_1024k("item.essentia.cell.1024k", true),
    ...
    Item_StorageComponent_16384k("item.storage.component.16384k", true),
