 ...
 *
 */
public class BlockArcaneAssembler extends AbstractBlockAEWrenchable {
    ...
    protected boolean onBlockActivated(final World world, final int x, final int y, final int z, final int side,
        ...
        if (tileAssembler instanceof TileArcaneAssembler) {
            ...
            if ((playerHolding != null) && (playerHolding.getItem() instanceof IMemoryCard)) {
                ...
                ((TileArcaneAssembler) tileAssembler)
                        .onMemoryCardActivate(player, (IMemoryCard) playerHolding.getItem(), playerHolding);
            } else {
