...
public class GuiArcaneCraftingTerminal extends GuiConstants_ACT implements ISortSource {
    ...
    private boolean clickHandler_Widgets(final int mouseX, final int mouseY, final int mouseButton) {
        ...
        if (ThEGuiHelper.INSTANCE.isPointInGuiRegion(
                GuiConstants_ACT.ME_ITEM_POS_Y,
                GuiConstants_ACT.ME_ITEM_POS_X,
                this.numberOfWidgetRows * GuiConstants_ACT.ME_ROW_HEIGHT,
                GuiConstants_ACT.ME_GRID_WIDTH,
                mouseX,
                mouseY,
                this.guiLeft,
                this.guiTop)) {
    ...
    private void drawCraftingAspects(final List<ArcaneCrafingCost> craftingCost) {
        ...
        for (ArcaneCrafingCost cost : craftingCost) {
            ...
            if (!cost.hasEnoughVis) {
                // Ping-pong the alpha
                alpha = ThEUtils.pingPongFromTime(
                        GuiConstants_ACT.ASPECT_COST_BLINK_SPEED,
                        GuiConstants_ACT.ASPECT_COST_MIN_ALPHA,
                        GuiConstants_ACT.ASPECT_COST_MAX_ALPHA);
            }
    ...
    private void setupTerminalStyle() {
        ...
        if (prevYOffset != this.lowerTerminalYOffset) {
            ((ContainerPartArcaneCraftingTerminal) this.inventorySlots)
                    .changeSlotsYOffset(this.lowerTerminalYOffset - prevYOffset);
        }
    ...
    protected void drawGuiContainerBackgroundLayer(final float alpha, final int mouseX, final int mouseY) {
        ...
        this.drawTexturedModalRect(
                ...
                0,
                0,
                GuiConstants_ACT.GUI_MAIN_BODY_WIDTH,
        ...
        for (int i = 0; i < (this.numberOfWidgetRows - GuiConstants_ACT.ME_DEFAULT_ROWS); ++i) {
            ...
            this.drawTexturedModalRect(
                    ...
                    yPos,
                    0,
                    GuiConstants_ACT.GUI_TEXTURE_ROW_V,
                    GuiConstants_ACT.GUI_MAIN_BODY_WIDTH,
        ...
        this.drawTexturedModalRect(
                this.guiLeft,
                this.guiTop + GuiConstants_ACT.GUI_UPPER_TEXTURE_HEIGHT + this.lowerTerminalYOffset,
                0,
                GuiConstants_ACT.ME_ROW_HEIGHT + 17,
                GuiConstants_ACT.GUI_MAIN_BODY_WIDTH,
                GuiConstants_ACT.GUI_TEXTURE_LOWER_HEIGHT + 18);

        // Draw view cells
        this.drawTexturedModalRect(
                this.guiLeft + GuiConstants_ACT.GUI_MAIN_BODY_WIDTH,
                this.guiTop,
                GuiConstants_ACT.GUI_MAIN_BODY_WIDTH,
                0,
                GuiConstants_ACT.GUI_VIEW_CELL_TEXTURE_WIDTH,
        ...
        int x = this.guiLeft + ContainerPartArcaneCraftingTerminal.VIEW_SLOT_XPOS,
                y = this.guiTop + ContainerPartArcaneCraftingTerminal.VIEW_SLOT_YPOS;
    ...
    protected void drawGuiContainerForegroundLayer(final int mouseX, final int mouseY) {
        ...
        boolean forceTooltipUpdate = ((System.currentTimeMillis() - this.lastTooltipUpdateTime)
                >= GuiConstants_ACT.WIDGET_TOOLTIP_UPDATE_INTERVAL);
        ...
        switch (button.id) {
            ...
            case GuiConstants_ACT.BUTTON_SEARCH_MODE_ID:
                ...
                this.searchField.setFocused(
                        (searchBoxMode == SearchBoxMode.AUTOSEARCH) || (searchBoxMode == SearchBoxMode.NEI_AUTOSEARCH));
    ...
    public void initGui() {
        ...
        this.buttonList.add(
                this.btnSortingMode = new GuiButtonSortingMode(
                        GuiConstants_ACT.BUTTON_SORT_MODE_ID,
                        this.guiLeft + GuiConstants_ACT.BUTTON_SORT_MODE_POS_X,
                        this.guiTop + GuiConstants_ACT.BUTTON_SORT_MODE_POS_Y,
                        GuiConstants_ACT.BUTTON_AE_SIZE,
                        GuiConstants_ACT.BUTTON_AE_SIZE));

        // Add sort direction button
        this.buttonList.add(
                this.btnSortingDirection = new GuiButtonSortingDirection(
                        GuiConstants_ACT.BUTTON_SORT_DIR_ID,
                        this.guiLeft + GuiConstants_ACT.BUTTON_SORT_DIR_POS_X,
                        this.guiTop + GuiConstants_ACT.BUTTON_SORT_DIR_POS_Y,
                        GuiConstants_ACT.BUTTON_AE_SIZE,
                        GuiConstants_ACT.BUTTON_AE_SIZE));

        // Add view type button
        this.buttonList.add(
                this.btnViewType = new GuiButtonViewType(
                        GuiConstants_ACT.BUTTON_VIEW_TYPE_ID,
                        this.guiLeft + GuiConstants_ACT.BUTTON_VIEW_TYPE_POS_X,
                        this.guiTop + GuiConstants_ACT.BUTTON_VIEW_TYPE_POS_Y,
                        GuiConstants_ACT.BUTTON_AE_SIZE,
                        GuiConstants_ACT.BUTTON_AE_SIZE));
        ...
        this.buttonList.add(
                this.btnSearchMode = new GuiButtonSearchMode(
                        GuiConstants_ACT.BUTTON_SEARCH_MODE_ID,
                        this.guiLeft + GuiConstants_ACT.BUTTON_SEARCH_MODE_POS_X,
                        this.guiTop + GuiConstants_ACT.BUTTON_SEARCH_MODE_POS_Y,
                        GuiConstants_ACT.BUTTON_AE_SIZE,
                        GuiConstants_ACT.BUTTON_AE_SIZE,
                        searchBoxMode));
