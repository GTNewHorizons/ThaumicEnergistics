...
public class GuiEssentiaCellTerminal extends GuiConstants_ECT implements IAspectSelectorGui {
    ...
    protected GuiEssentiaCellTerminal(final EntityPlayer player, final ContainerEssentiaCellTerminalBase container,
        ...
        for (int y = 0; y < GuiConstants_ECT.WIDGET_ROWS_PER_PAGE; y++) {
            ...
            for (int x = 0; x < GuiConstants_ECT.WIDGETS_PER_ROW; x++) {
                WidgetAspectSelector widget = new WidgetAspectSelector(
                        this,
                        null,
    ...
    private boolean isMouseOverWidgetArea(final int mouseX, final int mouseY) {
        return ThEGuiHelper.INSTANCE.isPointInGuiRegion(
                GuiConstants_ECT.WIDGET_OFFSET_Y,
                GuiConstants_ECT.WIDGET_OFFSET_X,
    ...
    protected void drawGuiContainerForegroundLayer(final int mouseX, final int mouseY) {
        ...
        if (this.selectedAspectStack != null) {
            ...
            this.fontRendererObj.drawString(
                    this.selectedInfoNamePrefix + aspectName,
                    GuiConstants_ECT.SELECTED_INFO_POS_X,
                    GuiConstants_ECT.SELECTED_INFO_NAME_POS_Y,
                    0);

            // Draw the amount
            this.fontRendererObj.drawString(
                    this.selectedInfoAmountPrefix + this.cacheAmountDisplay,
                    GuiConstants_ECT.SELECTED_INFO_POS_X,
                    GuiConstants_ECT.SELECTED_INFO_AMOUNT_POS_Y,
                    0);
        }
    }
    ...
    public void initGui() {
        ...
        this.searchBar = new GuiTextField(
                ...
                GuiConstants_ECT.SEARCH_WIDTH,
                GuiConstants_ECT.SEARCH_HEIGHT);
        ...
        this.buttonSortingMode = new GuiButtonSortingMode(
                0,
        ...
        this.buttonViewMode = new GuiButtonViewType(
                1,
