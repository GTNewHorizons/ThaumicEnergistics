...
public class GuiEssentiaIO extends ThEBaseGui implements WidgetAspectSlot.IConfigurable, IAspectSlotGui {
    ...
    public void initGui() {
        ...
        this.redstoneControlButton = new GuiButtonRedstoneModes(
                GuiEssentiaIO.REDSTONE_CONTROL_BUTTON_ID,
                this.guiLeft + GuiEssentiaIO.REDSTONE_CONTROL_BUTTON_POS_X,
                this.guiTop + GuiEssentiaIO.REDSTONE_CONTROL_BUTTON_POS_Y,
                GuiEssentiaIO.REDSTONE_CONTROL_BUTTON_SIZE,
                GuiEssentiaIO.REDSTONE_CONTROL_BUTTON_SIZE,
                this.redstoneMode,
                false);
        ...
        if (this.part instanceof PartEssentiaExportBus) {
            this.voidModeButton = new GuiButtonAllowVoid(
                    GuiEssentiaIO.ALLOW_VOID_BUTTON_ID,
                    this.guiLeft + GuiEssentiaIO.ALLOW_VOID_BUTTON_POS_X,
