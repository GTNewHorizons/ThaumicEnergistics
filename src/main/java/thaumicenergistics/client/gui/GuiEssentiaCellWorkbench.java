...
public class GuiEssentiaCellWorkbench extends ThEBaseGui implements IAspectSlotGui {
    ...
    protected void drawGuiContainerBackgroundLayer(final float alpha, final int mouseX, final int mouseY) {
        ...
        this.drawTexturedModalRect(
                this.guiLeft + ContainerEssentiaCellWorkbench.CELL_SLOT_X,
                this.guiTop + ContainerEssentiaCellWorkbench.CELL_SLOT_Y,
                GuiEssentiaCellWorkbench.CELL_BG_ICON.getU(),
                GuiEssentiaCellWorkbench.CELL_BG_ICON.getV(),
                GuiEssentiaCellWorkbench.CELL_BG_ICON.getWidth(),
