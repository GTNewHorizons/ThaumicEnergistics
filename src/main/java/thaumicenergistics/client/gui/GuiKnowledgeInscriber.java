...
public class GuiKnowledgeInscriber extends ThEBaseGui {
    ...
    public void initGui() {
        ...
        this.buttonSave = new GuiButtonSaveDelete(
                0,
                this.guiLeft + GuiKnowledgeInscriber.BUTTON_SAVE_POS_X,
                this.guiTop + GuiKnowledgeInscriber.BUTTON_SAVE_POS_Y,
                this.saveState);
        this.buttonList.add(this.buttonSave);

        // Create the clear grid button
        this.buttonClear = new GuiButtonClearCraftingGrid(
                1,
                this.guiLeft + GuiKnowledgeInscriber.BUTTON_CLEAR_POS_X,
                this.guiTop + GuiKnowledgeInscriber.BUTTON_CLEAR_POS_Y,
                8,
                8,
                false);
